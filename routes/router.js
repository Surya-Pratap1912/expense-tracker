...
router.delete(
  "/delete-expanse/:prodId",
  userAuth.Authenticate,
  expanse.deleteExpanse
);

router.put(
  "/update-expanse/:prodId",
  userAuth.Authenticate,
  expanse.updateExpanse
);

// //premium

router.get(
  "/purhase/premuiumMembership",
  userAuth.Authenticate,
  purchaseController.purchasePremium
);
router.post(
  "/purchase/updatetransectionstatus",
  userAuth.Authenticate,
  purchaseController.updatetransectionstatus
);

router.get("/premium/showLeaderBoard", userAuth.Authenticate, premium.showLead);

router.get(
  "/dowload/download-expanse",
  userAuth.Authenticate,
  expanse.downloadExpanse
);
